...
import kotlinx.android.synthetic.main.activity_lifeinsurance_third.*
import me.myatminsoe.mdetect.MDetect
import me.myatminsoe.mdetect.Rabbit
import java.util.*
import kotlin.collections.ArrayList
import com.example.civilservantapp.util.InputFilter
import kotlinx.android.synthetic.main.beneficiary_listitem.*


class LifeinsuranceThird : AppCompatActivity() {
    ...
    */
    ...
    private var relationship_List: ArrayList<String> = arrayListOf()
 ...
 */
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_lifeinsurance_third)
        ...
        if(MDetect.isUnicode()){
            ...
            //edt_beneficiaryrelationship.hint = Rabbit.zg2uni(getString(R.string.lblbeneficiaryrelation))
            ...
            when(it){
                ...
                is NetWorkViewState.Success->{
                    ...
                    for(i in 0..it.item.size-1){
                        relationshipList.add(it.item.get(i).description!!)
                    }

                    var relationshipdapter = ArrayAdapter(this, android.R.layout.simple_spinner_item, relationshipList)
        ...
        btnAddMore.setOnClickListener {
            ...
            val edtname_listitem = addview.findViewById<EditText>(R.id.edt_beneficiaryname_listiem)
            ...
            var edtfthname_listitem = addview.findViewById<EditText>(R.id.edt_beneficiaryfathername_listiem)
            var lblrelationship_listitem = addview.findViewById<TextView>(R.id.lblrelationship_listiem)
            var spnrelationship_listitem = addview.findViewById<Spinner>(R.id.spn_relationship_listiem)
            var lblage_listiem = addview.findViewById<TextView>(R.id.lblage_listiem)
            var edt_beneficiaryage_listiem = addview.findViewById<EditText>(R.id.edt_beneficiaryage_listiem)
            var lblpercentage_listiem = addview.findViewById<TextView>(R.id.lblpercentage_listiem)
            var edt_beneficiarypercent_listiem = addview.findViewById<EditText>(R.id.edt_beneficiarypercent_listiem)
            val btndelete = addview.findViewById<ImageView>(R.id.btndelete_listiem)
            if(MDetect.isUnicode()){
             ...
             */
            var fnrc_no = ArrayAdapter(this, android.R.layout.simple_spinner_item, resources.getStringArray(R.array.fnrc))
            ...
            var snrc_no = ArrayAdapter(this, android.R.layout.simple_spinner_item, snrcList)
            ...
            if(MDetect.isUnicode()){
                for (i in 0..resources.getStringArray(R.array.lastnrc).size-1){
                    thirdnrcArrayList.add(Rabbit.zg2uni(resources.getStringArray(R.array.lastnrc).get(i)))
                }
            }else{
                for (i in 0..resources.getStringArray(R.array.lastnrc).size-1){
            ...
            var thirdnrc_no = ArrayAdapter(this, android.R.layout.simple_spinner_item, thirdnrcArrayList)
            ...
            var relationshipAdapter = ArrayAdapter(this, android.R.layout.simple_spinner_item, relationshipList)
            ...
            clearTextBoxes()
            edt_beneficiaryname.requestFocus()
            hideKeyboard()
//            val addview = getLayoutInflater().inflate(R.layout.activity_lifeinsurance_thirdsub, null)
//            val txtname = addview.findViewById<TextView>(R.id.txtbeneficiaryname)
//            val txtnrc = addview.findViewById<TextView>(R.id.txtbeneficiarynrc)
//            val txtfathername = addview.findViewById<TextView>(R.id.txtbeneficiaryfthname)
//            val txtrelationship = addview.findViewById<TextView>(R.id.txtbeneficiaryrelationship)
//            val txtage = addview.findViewById<TextView>(R.id.txtbeneficiaryage)
//            val txtpercent = addview.findViewById<TextView>(R.id.txtbeneficiarypercent)
//            var lblbeneficiaryname = addview.findViewById<TextView>(R.id.lblbeneficiaryname)
//            var lblbeneficiarynrc = addview.findViewById<TextView>(R.id.lblbeneficiarynrc)
//            var lblbeneficiaryfthname = addview.findViewById<TextView>(R.id.lblbeneficiaryfthname)
//            var lblbeneficiaryrelationship = addview.findViewById<TextView>(R.id.lblbeneficiaryrelationship)
//            var lblbeneficiaryage = addview.findViewById<TextView>(R.id.lblbeneficiaryage)
//            var lblbeneficiarypercent = addview.findViewById<TextView>(R.id.lblbeneficiarypercent)
//            if(MDetect.isUnicode()){
//                lblbeneficiaryname.setText(Rabbit.zg2uni(getString(R.string.lblbeneficiaryname)))
//                lblbeneficiarynrc.setText(Rabbit.zg2uni(getString(R.string.lblbeneficiarynrc)))
//                lblbeneficiaryfthname.setText(Rabbit.zg2uni(getString(R.string.lblbeneficiaryfthname)))
//                lblbeneficiaryrelationship.setText(Rabbit.zg2uni(getString(R.string.lblbeneficiaryrelation)))
//                lblbeneficiaryage.setText(Rabbit.zg2uni(getString(R.string.lblbeneficiaryage)))
//                lblbeneficiarypercent.setText(Rabbit.zg2uni(getString(R.string.lblbeneficiarypercent)))
//            }
//            txtname.setText(edt_beneficiaryname.text.toString())
//            txtnrc.setText(firstnrc+"/"+secondnrc+thirdnrc+tie_nrcno.text.toString())
//            txtfathername.setText(edt_beneficiaryfathername.text.toString())
//            //txtrelationship.setText(edt_beneficiaryrelationship.text.toString())
//            txtage.setText(edt_beneficiaryage.text.toString())
//            txtpercent.setText(edt_beneficiarypercent.text.toString())
//            container.addView(addview)
//            clearTextBoxes()
        }
...
//                edtrelationship = edt_beneficiaryrelationship.text.toString()
...
//                deposit_amount!!, bnameList, bnrcList, fthNameList, relationshipList, ageList, percentList)
    ...
    fun bind_nrcSpinner(){
        ...
        for(i in 0..fnrcLength-1){
            mainnrcHashMap.put(resources.getStringArray(R.array.fnrc).get(i), (i+1).toString())
        }
        if(MDetect.isUnicode()){
        ...
        var subnrc_no = ArrayAdapter(this, android.R.layout.simple_spinner_item, resources.getStringArray(R.array.subfnrc))
    ...
    fun clearTextBoxes(){
        //edt_beneficiaryrelationship.setText("")
        tie_nrcno.setText("")
